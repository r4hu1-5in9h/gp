function [X, f, i, exitflag, output] = minimize_minfunc_vis(X, f, options, varargin)
...
%         trace.param_path - X value after each iteration
%
...
[X, f, exitflag, output] = minFunc_vis(fw, unwrap(X0), options,varargin{:});
i = output.funcCount;
